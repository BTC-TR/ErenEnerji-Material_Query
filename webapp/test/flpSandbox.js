		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comerenmaterialquery-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comerenmaterialquery-display": {
								"semanticObject": "comerenmaterialquery",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.eren.materialquery",
									"url": sap.ui.require.toUrl("com/eren/materialquery")
								}
							}
						}
					}
